(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './getStyles', './getAttributes', '../utils/applyD3ReactId'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./getStyles'), require('./getAttributes'), require('../utils/applyD3ReactId'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.getStyles, global.getAttributes, global.applyD3ReactId);
        global.extractData = mod.exports;
    }
})(this, function (exports, _getStyles, _getAttributes, _applyD3ReactId) {
    'use strict';
